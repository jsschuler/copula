...
# (Milestone 3), and MST/persistent-topology ordering (Milestone 4). DAGs,
# Bernstein basis, Sinkhorn normalization, EVT tails, and language bindings
# are excluded until their respective milestones (spec section 31).
